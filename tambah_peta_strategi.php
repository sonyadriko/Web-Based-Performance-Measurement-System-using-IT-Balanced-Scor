                        ...
                        <div class="card-body">
                            ...
                            <form action="tambah_peta_strategi.php" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputNamaPeta" name="inputNamaPeta" aria-describedby="inputNamaPeta">
                                </div>

                                <div class="mb-3">
                                    <label for="inputSasaranStrategi" class="form-label">Sasaran Strategi</label>
                                    <input type="text" class="form-control" id="inputSasaranStrategi" name="inputSasaranStrategi" aria-describedby="inputSasaranStrategi">
                                </div>

                                <div class="mb-3">
                                    <label for="inputIndikatorKinerja" class="form-label">Indikator Kinerja</label>
                                    <input type="text" class="form-control" id="inputIndikatorKinerja" name="inputIndikatorKinerja" aria-describedby="inputIndikatorKinerja">
                                </div>

                                <div class="mb-3">
                                    <label for="inputPembobotan" class="form-label">Pembobotan</label>
                                    <input type="text" class="form-control" id="inputPembobotan" name="inputPembobotan" aria-describedby="inputPembobotan">
                                </div>

                                <div class="mb-3">
                                    <label for="inputTarget" class="form-label">Target</label>
                                    <input type="text" class="form-control" id="inputTarget" name="inputTarget" aria-describedby="inputTarget">
                                </div>
